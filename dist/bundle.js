...
/* harmony export */ });
/* harmony import */ var _lib_state_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/state.js */ "./src/lib/state.js");
// components/Notes.js
...
function renderNotes(container) {
    ...
    notes.value = localStorage.getItem(`notes_${(0,_lib_state_js__WEBPACK_IMPORTED_MODULE_0__.getState)().currentTopic}`) || '';

    saveBtn.addEventListener('click', () => {
        localStorage.setItem(`notes_${(0,_lib_state_js__WEBPACK_IMPORTED_MODULE_0__.getState)().currentTopic}`, notes.value);
        alert('Notes saved!');
    });
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderReview: () => (/* binding */ renderReview)
/* harmony export */ });
/* harmony import */ var _lib_state_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/state.js */ "./src/lib/state.js");
// components/Review.js


function renderReview(container, toggleBtn) {
    ...
    editBtn.addEventListener('click', () => {
        ...
        if (isEditable) {
            (0,_lib_state_js__WEBPACK_IMPORTED_MODULE_0__.updateReview)('custom', { prompt: 'Custom', answer: reviewContent.innerText, correct: true });
        }
    });
...
function updateReviewContent(content) {
    const state = (0,_lib_state_js__WEBPACK_IMPORTED_MODULE_0__.getState)();
...
function renderSlide(container) {
    container.innerHTML = '';
    const slide = (0,_lib_state_js__WEBPACK_IMPORTED_MODULE_0__.getCurrentSlide)();
    if (!slide) return;
    ...
    slideDiv.querySelector('.next-slide-btn').addEventListener('click', () => (0,_lib_state_js__WEBPACK_IMPORTED_MODULE_0__.nextSlide)() && renderSlide(container));
}
...
function checkAnswer(slide, container) {
    ...
    if (isCorrect) {
        (0,_lib_state_js__WEBPACK_IMPORTED_MODULE_0__.updateReview)(slide.id, { prompt: slide.prompt, answer: slide.answer, correct: true });
        setTimeout(() => (0,_lib_state_js__WEBPACK_IMPORTED_MODULE_0__.nextSlide)() && renderSlide(container), 2000);
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderTopicSelect: () => (/* binding */ renderTopicSelect)
/* harmony export */ });
/* harmony import */ var _lib_state_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/state.js */ "./src/lib/state.js");
// components/TopicSelect.js

console.log("topicselect.js loaded");
function renderTopicSelect(container, onChange) {
    const select = document.createElement('select');
    select.className = 'topic-select';
    const topics = (0,_lib_state_js__WEBPACK_IMPORTED_MODULE_0__.getState)().topics;
    ...
    select.addEventListener('change', () => {
        (0,_lib_state_js__WEBPACK_IMPORTED_MODULE_0__.setTopic)(select.value);
        onChange();
    });
}
...
function updateReview(slideId, reviewEntry) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkkbd"] = self["webpackChunkkbd"] || [];
...
/*!********************!*\
  ...
  \********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_db_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/db.js */ "./src/lib/db.js");
/* harmony import */ var _lib_state_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/state.js */ "./src/lib/state.js");
/* harmony import */ var _components_Slide_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/Slide.js */ "./src/components/Slide.js");
/* harmony import */ var _components_TopicSelect_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/TopicSelect.js */ "./src/components/TopicSelect.js");
/* harmony import */ var _components_Review_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/Review.js */ "./src/components/Review.js");
...
async function init() {
    const topics = await (0,_lib_db_js__WEBPACK_IMPORTED_MODULE_0__.fetchTopics)();
    (0,_lib_state_js__WEBPACK_IMPORTED_MODULE_1__.initState)(topics);
    ...
    (0,_components_TopicSelect_js__WEBPACK_IMPORTED_MODULE_3__.renderTopicSelect)(topicSelectContainer, () => {
        (0,_components_Slide_js__WEBPACK_IMPORTED_MODULE_2__.renderSlide)(slideContainer);
      //renderReview(reviewContainer, toggleReviewBtn);
      //renderNotes(notesContainer);
    });
    (0,_components_Slide_js__WEBPACK_IMPORTED_MODULE_2__.renderSlide)(slideContainer);
    (0,_components_Review_js__WEBPACK_IMPORTED_MODULE_4__.renderReview)(reviewContainer, toggleReviewBtn);
    (0,_components_Notes_js__WEBPACK_IMPORTED_MODULE_5__.renderNotes)(notesContainer);
}
